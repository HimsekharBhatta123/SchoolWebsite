  ...
  return (
    <div className="admin-page">
      ...
      <div className="fees-structure">
        ...
        <table className='fees-structure-table-admin'>
          <thead>
            <tr>
              <th>Class</th>
              <th>Amount</th>
      ...
      <div className="school-hours">
        ...
        <table className="class-schedule-admin">
          <thead>
            <tr>
              <th>ID</th>
              <th>Day</th>
      ...
      <div className="class-subjects-admin">
        ...
        <table className="class-subjects-table-admin">
          <thead>
            <tr>
              <th>ID</th>
              <th>Subject</th>
      ...
      <div className="teacher-profile">
        ...
        <table className='teachers-admin'>
          <thead>
            <tr>
              <th>Name</th>
              <th>Qualification</th>
      ...
      <div className='notice'>
        ...
        <table className='notice-table-admin'>
          <thead>
            <tr>
              <th>Notice</th>
              <th>Timing</th>
      ...
      <div className='students'>
        <table className='students-table-admin'>
          <thead>
            <tr>
              <th>Name</th>
              <th>Email</th>
